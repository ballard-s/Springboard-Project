...
From the analyses performed, the code, a paper describing the analyses and results, as well as a slide deck will be available to researchers who would like to pursue pharmacotherapies for learning and memory in individuals with Down Syndrome.